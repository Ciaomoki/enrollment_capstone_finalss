...
<head>
  ...
  <title>Evaluator Reports - One Enrollment</title>
  <!-- External Resources -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" />
  <link rel="stylesheet" href="../assets/globalstyles.css" />
  <link rel="stylesheet" href="../Evaluator/eval css/evalreport.css" />
</head>

<body class="evaluator-reports">
  <!-- Top Yellow Stripe -->
  ...
  <div class="global-container">
    ...
    <main>
      ...
      <!-- ===================== Top Bar (Navigator + Current Student) ===================== -->
      <section class="reports-topbar" aria-label="Student Navigator">
        <!-- Prev -->
        ...
        <div class="student-chooser">
          ...
          <div class="combo-panel" role="listbox" aria-labelledby="reportsStudentComboBtn" hidden>
            ...
            <ul class="combo-options">
              <!-- Example alphabetized options: replace with real data -->
      ...
      <!-- ===================== Table Card (separate from navigator) ===================== -->
      <section class="table-section">
        <div class="reports-card">
          <h2 class="section-title">Finalized Schedule</h2>

          <!-- Scroll window sized to rows (default 10). To adjust: set style="--report-rows:12" -->
          ...
          <!-- Custom handle (JS binds drag); native resize also enabled on .table-scroll -->
      ...
      <!-- X-scroll hint overlay (shown via JS when overflow-x exists) -->
  ...
  <div id="bottomNav">
    ...
    <button id="navLeftBtn" class="nav-button secondary" type="button"
            data-href="evaldashb.php">
      <i class="fa-solid fa-chevron-left" aria-hidden="true"></i> Dashboard
    </button>
  </div>

  <script src="../Evaluator/eval js/evalreport.js"></script>
</body>
</html>
